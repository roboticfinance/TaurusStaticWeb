...
/*         {
  ...
  watch: {
    ...
    isThemeDark(val) {
      const color = this.navbarColor == "#fff" && val ? "#2F4554" : "#fff"
  ...
  methods: {
    ...
    updateNavbar(val) {
      if (val == "static") this.updateNavbarColor(this.isThemeDark ? "#2F4554" : "#fff")
      this.navbarType = val
    },
  ...
  created() {
    const color = this.navbarColor == "#fff" && this.isThemeDark ? "#2F4554" : this.navbarColor
    this.updateNavbarColor(color)
